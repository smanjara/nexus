...
def setup_conf(options):
    ...
    if not workspace:
        logger.log.warn("Unable to find WORKSPACE in env variable, assuming you have it conf")
    else:
    ...
    if not job_name:
        logger.log.warn("Unable to find JOB_NAME in env variable, assuming you have it in conf")
    else:
    ...
    if not existing_nodes:
        logger.log.warn("Unable to find EXISTING_NODES env variable, assuming have it in conf.")
    else:
